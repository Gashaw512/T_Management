...
import { enUS } from "date-fns/locale"; // Only import enUS now
// Removed i18next imports
...
// Removed getLocale function as it's no longer needed.
...
const TasksToday: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      // Load daily quote from the hardcoded array
      if (isMounted.current && dailyQuotes.length > 0) {
      ...
      <div className="w-full max-w-5xl">
            ...
            <div className="flex items-end justify-between mb-4">
              <div className="flex items-end">
                ...
                <span className="text-gray-500">
                  {format(new Date(), "PPP", { locale: enUS })}
                </span>
              </div>
        ...
        {todaySettings.showMetrics && (
          <div className="mb-2 grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-4">
              <h3 className="text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">Overview</h3>
                    ...
                    {(() => {
                      ...
                      const getTooltipText = () => {
                        if (trend.direction === 'same') {
                          ...
                          return `${trend.percentage}% more than average`;
                        } else {
                          return `${trend.percentage}% less than average`;
                        }
                      };
          ...
          <div className="mt-2">
            ...
            {metrics.suggested_tasks.length > 0 && (
              <div className="mb-6">
                ...
                >
                  <h3 className="text-xl font-medium">Suggested</h3>
                  <div className="flex items-center">
        ...
        {todaySettings.showCompleted && metrics.tasks_completed_today.length > 0 && (
          <div className="mb-6">
            ...
            >
              <h3 className="text-xl font-medium">Completed Today</h3>
              <div className="flex items-center">
