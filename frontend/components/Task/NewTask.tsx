    ...
    <div className="mb-2">
      <div className="flex items-center justify-between py-3 px-4 border-b border-gray-200 dark:border-gray-800 rounded-lg shadow-sm bg-white dark:bg-gray-900">
        ...
        <input
          ...
          placeholder="Add New Task" // Hardcoded string
        />
      </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-2">
              <p className="text-sm text-blue-800 dark:text-blue-200">
                <strong>Make it more descriptive!</strong> {/* Hardcoded string */}
              </p>
              <p className="text-xs text-blue-700 dark:text-blue-300 mt-1">
                Try adding more details like "Call dentist to schedule cleaning appointment" instead of just "Call dentist" {/* Hardcoded string */}
              </p>
            </div>
          </div>
        </div>
