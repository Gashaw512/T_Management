  ...
  return (
    <div className="px-4 py-4 border-b border-gray-200 dark:border-gray-700">
      <input
        ...
        placeholder="Add Task Name" // Hardcoded string
      />
          ...
          <div className="flex items-start">
            ...
            <div className="ml-2">
              <p className={`text-sm ${
                ...
                <strong>
                  {taskAnalysis.reason === 'short' && 'Make it more descriptive!'} {/* Hardcoded string */}
                  {taskAnalysis.reason === 'no_verb' && 'Add an action verb!'} {/* Hardcoded string */}
                  {taskAnalysis.reason === 'vague_pattern' && 'Be more specific!'} {/* Hardcoded string */}
                </strong>
              </p>
              {taskAnalysis.suggestion && (
                <p className={`text-xs mt-1 ${
                  ...
                  {taskAnalysis.suggestion} {/* Directly use the suggestion string */}
                </p>
              )}
            </div>
          </div>
