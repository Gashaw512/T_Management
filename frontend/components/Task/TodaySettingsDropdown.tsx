...
const TodaySettingsDropdown: React.FC<TodaySettingsDropdownProps> = ({
  ...
  // Replaced t() calls with hardcoded English strings for labels
  const settingsOptions: Array<{key: keyof typeof localSettings, label: string, icon: React.ElementType, disabled?: boolean}> = [
    { key: 'showDailyQuote', label: 'Show Daily Quote', icon: ChatBubbleBottomCenterTextIcon },
    { key: 'showMetrics', label: 'Show Metrics', icon: ChartBarIcon },
    { key: 'showProductivity', label: 'Show Productivity Insights', icon: LightBulbIcon },
    { key: 'showIntelligence', label: 'Show Intelligence Suggestions', icon: SparklesIcon },
    { key: 'showDueToday', label: 'Show Due Today Tasks', icon: ClockIcon },
    { key: 'showCompleted', label: 'Show Completed Tasks', icon: TrophyIcon },
  ];
