...
const Navbar: React.FC<NavbarProps> = ({
  isDarkMode, // This prop is not used in the current JSX, but kept for completeness
  toggleDarkMode, // This prop is not used in the current JSX, but kept for completeness
  currentUser,
  setCurrentUser,
  isSidebarOpen,
  setIsSidebarOpen,
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {isDropdownOpen && (
              ...
              >
                ...
                >
                  Profile Settings {/* Hardcoded string */}
                </Link>
                <button
                  onClick={() => {
                    setIsDropdownOpen(false);
