    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
        <div className="text-xl font-semibold text-gray-700 dark:text-gray-200">
          Loading area details... {/* Hardcoded string */}
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
        <div className="text-red-500 text-lg">
          {isError ? 'Error loading area details.' : 'Area not found.'} {/* Hardcoded strings */}
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
          Area Details: {area?.name} {/* Hardcoded string */}
        </h2>
        ...
        >
          View Projects for {area?.name} {/* Hardcoded string with dynamic name */}
        </Link>
      </div>
    </div>
  );
