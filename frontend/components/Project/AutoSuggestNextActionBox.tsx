...
interface AutoSuggestNextActionBoxProps {
  ...
  onDismiss: () => void;
  projectName: string; // This prop is not used in the current JSX, but kept for completeness
}
...
const AutoSuggestNextActionBox: React.FC<AutoSuggestNextActionBoxProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (actionDescription.trim()) {
      ...
      showSuccessToast('Next action added successfully!'); // Hardcoded string
    ...
    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-6 mb-6">
        ...
        <div className="flex items-center">
          ...
          <div>
            <h3 className="text-lg font-semibold text-blue-800 dark:text-blue-200 mb-1">
              What's the very next physical action for this project? {/* Hardcoded string */}
            </h3>
          </div>
        </div>
        <button
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="relative">
          <input
            ...
            placeholder="e.g., Call John to schedule meeting, Research competitors online, Create project folder..." // Hardcoded string
        ...
        <div className="flex justify-between items-center">
          ...
          >
            Add Next Action {/* Hardcoded string */}
          </button>
        </div>
      </form>
      ...
      <div className="mt-4 p-3 bg-blue-100/50 dark:bg-blue-900/30 rounded-lg border border-blue-200 dark:border-blue-700">
        <p className="text-xs text-blue-700 dark:text-blue-300 flex items-center">
          ...
          <span>
            Think of the smallest, most concrete step you can take right now to move this project forward. {/* Hardcoded string */}
          </span>
        </p>
      </div>
    </div>
