        ...
        >
          {project.image_url ? (
            ...
            <span
              ...
              aria-label="Project initials" // Hardcoded string
            >
      ...
      >
        ...
        <div className="relative">
          <button
            ...
            aria-label="Toggle dropdown menu" // Hardcoded string
          >
        ...
        <div className="absolute bottom-4 left-0 right-0 px-4">
          <div className="flex items-center space-x-2">
            <div
              ...
              title={`Completion: ${getCompletionPercentage()}%`} // Hardcoded string, using template literal
            >
              <div
