...
const ProjectModal: React.FC<ProjectModalProps> = ({
  ...
  const handleDeleteConfirm = () => {
    if (project && project.id && onDelete) {
      onDelete(project.id);
      showSuccessToast('Project deleted successfully!'); // Hardcoded string
          ...
          <form className="flex flex-col h-full">
            <fieldset className="flex flex-col h-full">
              <div className="p-4 space-y-3 flex-1 text-sm overflow-y-auto min-h-0">
                <div className="py-4">
                  <input
                    ...
                    placeholder="Enter project name" // Hardcoded string
                  />
                </div>
                ...
                <div className="pb-3">
                  ...
                  <textarea
                    ...
                    placeholder="Enter project description (optional)" // Hardcoded string
                  ></textarea>
                </div>

                <div className="pb-3">
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Project Image {/* Hardcoded string */}
                  </label>
                  ...
                  >
                    ...
                    Browse Image {/* Hardcoded string */}
                  </button>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    Upload an image for your project (max 5MB) {/* Hardcoded string */}
                  </p>
                </div>
                ...
                <div className="pb-3">
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Area (optional) {/* Hardcoded string */}
                  </label>
                  <select
                    id="projectArea"
                    name="area_id"
                    ...
                    className="block w-full rounded-md shadow-sm px-3 py-2 text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 transition duration-150 ease-in-out"
                  >
                    <option value="">No Area</option> {/* Hardcoded string */}
                    {areas.map((area) => (
              ...
              <div className="p-3 flex-shrink-0 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-2">
                ...
                >
                  {isUploading ? 'Uploading...' : (project ? 'Update Project' : 'Create Project')} {/* Hardcoded string */}
                </button>
              </div>
            </fieldset>
          </form>
