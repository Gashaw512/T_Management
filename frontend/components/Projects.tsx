...
useEffect(() => {
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
        <div className="text-xl font-semibold text-gray-700 dark:text-gray-200">
          Loading projects... {/* Hardcoded string */}
        </div>
      </div>
    );
  }
  ...
  if (isError) {
    return (
      <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
        <div className="text-red-500 text-lg">Error loading projects. Please try again.</div> {/* Hardcoded string */}
      </div>
    );
  }
  ...
  return (
    <div className="flex justify-center px-4 lg:px-2">
      <div className="w-full max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 space-y-4 md:space-y-0">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:space-x-4">
            <div className="w-full md:w-auto">
              ...
              >
                <option value="true">Active</option> {/* Hardcoded string */}
                <option value="false">Inactive</option> {/* Hardcoded string */}
                <option value="all">All</option> {/* Hardcoded string */}
              </select>
            </div>
            ...
            <div className="w-full md:w-auto">
              ...
              <select
                ...
                className="block w-full p-2 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                <option value="">All Areas</option> {/* Hardcoded string */}
                {areas.map((area) => (
        ...
        <div className="mb-4">
          <div className="flex items-center bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm p-2">
            ...
            <input
              type="text"
              placeholder="Search projects..." /* Hardcoded string */
              value={searchQuery}
        ...
        >
          {Object.keys(searchFilteredGroupedProjects).length === 0 ? (
            <div className="text-gray-700 dark:text-gray-300">
              No projects found. {/* Hardcoded string */}
            </div>
          ) : (
      ...
      {isConfirmDialogOpen && (
        <ConfirmDialog
          title="Delete Project" // Hardcoded string
          message={`Are you sure you want to delete "${projectToDelete?.name}"?`} // Hardcoded string
