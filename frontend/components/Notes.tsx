    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
        <div className="text-xl font-semibold text-gray-700 dark:text-gray-200">
          Loading notes... {/* Hardcoded string */}
        </div>
      </div>
    );
  }
      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="mb-4">
          <div className="flex items-center bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm p-2">
            ...
            <input
              type="text"
              placeholder="Search notes..." /* Hardcoded string */
              value={searchQuery}
              ...
              >
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    aria-label={`Edit note ${note.title}`} /* Hardcoded string */
                    title={`Edit note: ${note.title}`} /* Hardcoded string */
                  >
                  ...
                  <button
                    ...
                    aria-label={`Delete note ${note.title}`} /* Hardcoded string */
                    title={`Delete note: ${note.title}`} /* Hardcoded string */
                  >
        ...
        {isConfirmDialogOpen && noteToDelete && (
          <ConfirmDialog
            title="Delete Note" // Hardcoded string
            message={`Are you sure you want to delete "${noteToDelete.title}"?`} // Hardcoded string
